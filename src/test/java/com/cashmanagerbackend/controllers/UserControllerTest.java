...
class UserControllerTest {
    ...
    void patchUser() throws Exception {
        ...
        when(userService.patchUser(principal.getName(), userUpdateDTO, locale, variables)).thenReturn(userResponseDTO);
        ...
        verify(userService, times(1)).patchUser(principal.getName(), userUpdateDTO, locale, variables);
    }
